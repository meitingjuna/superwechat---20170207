...
public class SuperWeChatDBManager {
    ...
    public synchronized Integer saveMessage(InviteMessage message) {
        ...
        if (db.isOpen()) {
            ...
            values.put(InviteMessgeDao.COLUMN_NAME_AVATAR, message.getAvatarSuffix());
    ...
    synchronized public List<InviteMessage> getMessagesList() {
        ...
        if (db.isOpen()) {
            ...
            while (cursor.moveToNext()) {
                ...
                String avatarSuffix = cursor.getString(cursor.getColumnIndex(InviteMessgeDao.COLUMN_NAME_AVATAR));
    ...
    synchronized public Map<String, User> getAppContactList() {
        ...
        if (db.isOpen()) {
            ...
            while (cursor.moveToNext()) {
                ...
                user.setMAvatarLastUpdateTime(cursor.getString(cursor.getColumnIndex(UserDao.USER_COLUMN_NAME_AVATAR_SUFFIX)));
